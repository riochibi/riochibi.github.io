...
該当する見出しを探してください。
* 更新したのにサイトに反映されない→ ブラウザで Ctrl+Shift+R（強制リロード）を試してください。またはシークレットモードで開いてみてください。
...
&#x20;  cd C:\\Users\\furuy\\riochibi.github.io
